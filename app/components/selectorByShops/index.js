angular.module('components.selectorByShops', [])
  .factory('selectorShops', ['$ccModal', '$rootScope', function ($ccModal, $rootScope) {
    var modalOptions = {
      scope: $rootScope.$new(),
      body: GLOBAL_STATIC.rootModule + '/components/selectorByShops/tpls/body.html',
      footer: GLOBAL_STATIC.rootModule + '/components/selectorByShops/tpls/footer.html',
      controller: 'selectorShopCtrl',
      controllerAs: '$ctrl',
      style: {
        'width': '1000px',
        'min-width': '1000px',
  ...
  .directive('selectorTreeManager', ['$compile', 'ShopsResources', function ($compile, ShopsResources) {
