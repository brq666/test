angular.module('components.selectorByShops')
	.service('ShopsResources', ['$resource', function($resource) {
    return {
      // 选择器
      tree: $resource(GLOBAL_STATIC.componentRoot + 'shop/selector/:pkid/tree', {pkid: '@pkid', type: 'shop'}),										// 选择器菜单
      edecathlonTree: $resource(GLOBAL_STATIC.componentRoot + 'product/selector/:pkid/edecathlon/tree', {pkid: '@pkid'}),										// 选择器菜单
