...
(function($){
  ...
  _handler = {
    ...
    onMousedownNode: function(eventMouseDown, _node) {
      var e = eventMouseDown || window.event
      if(e.target.className === 'customerdeleteCreateNode') {
        return false;
      }
      var i,l,
  ...
  _view = {
    ...
    editNode: function(setting, node) {
      ...
      /* ztree Ô´ÂëÐÞ¸Ä£¬Ìí¼ÓnodeÊÇÏÔÊ¾É¾³ýÏî -PEACH
      * <em class='customerdeleteCreateNode'>X</em>"
      *  view:ÉèÖÃ²ÎÊý cutomDeleteElement¡ªtrue || false£¬ÊÇ·ñÏÔÊ¾É¾³ýÏî
      */
