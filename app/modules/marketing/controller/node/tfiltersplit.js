angular.module("campaign.controllers").controller('splitNodeCtrl', ['$scope', '$window', '$location', '$http', 'splitNodeDate', 'getListService',
  function($scope, $window, $location, $http, splitNodeDate, getListService) {
