(function (window, angular, undefined) {
    ...
    app.controller('vipSetting', ["$scope", "$rootScope","saveService", "getListService", "$compile",
        ...
        $scope.getReports = function () {
            ...
            $('.dataInfoList').flexigrid({
                ...
                colModel: [
                    ...
                    { display: '客户提交数', name: 'submitNum', width: 1, sortable: false, align: 'center', dataindex: 'submitNum'},
                    { display: '设置成功数', name: 'successNum', width: 1, sortable: false, align: 'center', dataindex: 'successNum'},
                    { display: '设置失败数', name: 'failNum', width: 1, sortable: false, align: 'center', dataindex: 'failNum'},
                    {
                        display: '设置会员时间', name: 'setGradeTime', width: 1, sortable: false, align: 'center', dataindex: 'setGradeTime', renderer: function (v) {
                        return  "<span class='ac_status_grid ac_status_" + v + "' title='"+setISO(v, "all")+"'>" + setISO(v, "all") + "</span>";
                    }
                    },
                    { display: '下载数据', name: 'enable', width: 1, align: 'center', dataindex: 'enabled', mapping: ['fileUrl'],
