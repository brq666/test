angular.module('campaign.controllers').controller('CampaignIframeCtrl', ['$resource', '$scope', '$stateParams', '$sce', function($resource, $scope, $stateParams, $sce) {
  const _this = this;
  const context = $stateParams.moduleUrl || '';
  $resource(GLOBAL_STATIC.portalRoot + 'module/' + CAMPAIGN_STATIC.tenantId + '/marketing').query(function(ctcMenusData) {
    var matchUrl="";
